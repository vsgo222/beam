...
public class AgentSimToPhysSimPlanConverter implements BasicEventHandler, MetricsSupport, IterationStatsProvider, Observer {
    ...
    private void setupActorsAndRunPhysSim(int iterationNumber) {
        ...
        CarTravelTimeHandler carTravelTimeHandler = CarTravelTimeHandler$.MODULE$.apply(caccVehiclesMap);
        ...
        log.info("AVG car travel time: {}", carTravelTimeHandler.compute().toString());
        ...
        completableFutures.add(CompletableFuture.runAsync(() -> linkSpeedStatsGraph.notifyIterationEnds(iterationNumber, travelTimeCalculator.getLinkTravelTimes())));

        completableFutures.add(CompletableFuture.runAsync(() -> linkSpeedDistributionStatsGraph.notifyIterationEnds(iterationNumber, travelTimeCalculator.getLinkTravelTimes())));
