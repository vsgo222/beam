...
rhPassengers <- events %>%
  ...
  mutate(pct = n / sum(n))
rhPassengers %>%
  kbl(digits = 2, align = 'lrr', caption = "Trips by Occupancy") %>%
  kable_styling(
    bootstrap_options = c("striped", "hover", "responsive"),
    full_width = F)
...
events %>%
  ...
  kbl(digits = 2, align = 'lrrr', caption = "Travel Times by Occupancy (min)") %>%
  kable_styling(
    bootstrap_options = c("striped", "hover", "responsive"),
    full_width = F)
```
...
rhTimes %>%
  ...
  kbl(digits = 2, caption = "RideHail Reservation Outcomes") %>%
  kable_styling(
    bootstrap_options = c("striped", "hover", "responsive"),
    full_width = F
    ) %>%
