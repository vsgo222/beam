...
BEAM can be configured to output an `events.csv` file for each iteration. This is a 10% scenario that I'm using for further testing:
```{r}
eventsCSV = "R/eventHandler/test/10_pct_test.csv"
```
