...
events <- read_csv("ITERS/it.0/0.events.csv.gz")
# wc person ids
wc_ids <- read_csv("data/persons_wc_mini.csv") %>%
  mutate(wc_var = "TRUE")
# wav vehicle ids
wavs <- read_csv("ITERS/it.0/0.rideHailFleet.csv.gz") %>%
