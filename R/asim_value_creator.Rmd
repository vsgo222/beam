...
asim_asc[asim_asc == "sr2"] <- "hov2_teleportation"
asim_asc[asim_asc == "sr3p"] <- "hov3_teleportation"
```
...
alts <- c("bike","bike_transit","car","drive_transit","ride_hail","ride_hail_pooled","ride_hail_transit","walk","walk_transit","hov2_teleportation","hov3_teleportation")
vals <- c(1:11)
alt_vals <- data.frame(vals,alts) %>% as_tibble()
  ...
  # walk                8
  # walk_transit        9
  # hov2_teleportation  10
  # hov3_teleportation  11
alt_vals
```
