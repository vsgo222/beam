...
```{r, warning = FALSE, message = FALSE}
cf_files <- list.files("utah_statewide/coeffs/coeffs/")
cf_path <- "utah_statewide/coeffs/coeffs/"
...
```{r, warning = FALSE, message = FALSE}
cst_files <- list.files("utah_statewide/coeffs/const/")
cst_path <- "utah_statewide/coeffs/const/"
...
```{r, warning = FALSE, message = FALSE}
coeff_files <- list.files("wfrc/WF TDM v8.3.1 - 2020-08-17/2_ModelScripts/4_ModeChoice/coeffs/coeffs/")
coeff_path <- "wfrc/WF TDM v8.3.1 - 2020-08-17/2_ModelScripts/4_ModeChoice/coeffs/coeffs/"
...
```{r, warning = FALSE, message = FALSE}
const_files <- list.files("wfrc/WF TDM v8.3.1 - 2020-08-17/2_ModelScripts/4_ModeChoice/coeffs/const/")
const_path <- "wfrc/WF TDM v8.3.1 - 2020-08-17/2_ModelScripts/4_ModeChoice/coeffs/const/"
...
![**Default Utility Equation for Mode Choice Models**](nchrp_report716/utility_equation.png)
</center>
...
![**Table 1: Home-Based Work Mode Choice Model Options**](nchrp_report716/models_hbw.png)
...
![**Table 2: Home-Based Other Mode Choice Model Options**](nchrp_report716/models_hbo.png)
...
![**Table 3: Non Home-Based Mode Choice Model Options**](nchrp_report716/models_nhb.png)
...
```{r, warning=FALSE,message=FALSE}
asim_coeff <- read_csv("mtc/tour_mode_choice_coefficients.txt")
asim_tour_coeffs <- read_csv("mtc/mtc_2012_tour_mode_choice_coefficients.txt")
